...
const renderText  = (text, classNem, baseWeight=400)=>{
...
const Welcome = () => {
    ...
    useGSAP(()=>{
       const titleCleanup = setupTextHover(titleRef.current,"title");
        const subTitelCleanup = setupTextHover(subtitleRef.current,"subtitle");
    ...
    return (
        <section id={`welcome`}>
            <p ref={subtitleRef}>{renderText("Hey, I am Rishad ! Welcome to my ","text-3xl font-georama",100)}</p>
